...
export const MapLoader = function () {
  return new Promise((resolve) => {
    if (window.AMap) {
      ...
      createScript('https://webapi.amap.com/maps?v=1.4.15&key=718c3fc76e785a4edf7fba37431b7a38&plugin=AMap.Autocomplete,AMap.PlaceSearch,AMap.PolyEditor,AMap.CircleEditor').then(() => {
        resolve();
      });
    }
  });
...
export const worldMap = function () {
  const worldCoordMap = {
    ...
    白俄罗斯共和国: [27.953389, 53.709807],
    伯利兹: [-88.49765, 17.189877],
    百慕大群岛: [-64.7505, 32.3078],
    ...
    瑞士: [8.22751199999999, 46.818188],
    智利: [-71.542969, -35.675147],
    中国: [115.003155, 38.868041],
    ...
    牙买加: [-7.297508, 18.109581],
    约旦: [36.238414, 30.585164],
    日本: [138.252924, 36.204824],
    哈萨克斯坦共和国: [66.923684, 48.019573],
    ...
    '美国,加拿大': [-95.712891, 37.09024],
    乌兹别克斯坦共和国: [64.585262, 41.377491],
    ...
    巴林: [50.5577, 26.070335],
    新加坡: [103.849157, 1.358448]
  };
